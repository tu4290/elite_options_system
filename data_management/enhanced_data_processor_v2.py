...
class ITSIntegrator_EDP:
    ...
    def _load_its_instance(self):
        ...
        try:
            ...
            self.its_instance = integrated_strategies_v2.IntegratedTradingSystem(config_path=config_path_for_its) # Removed ids_imported_successfully
            ...
            self.its_instance = DummyIntegratedTradingSystem_EDP(config_path=self.config_manager.provided_config_path, edp_logger=self.logger) # Removed ids_imported_successfully
...
class DummyIntegratedTradingSystem_EDP:
    def __init__(self, config_path: Optional[str] = None, edp_logger: Optional[logging.Logger] = None): # Removed ids_imported_successfully
        self.logger = (edp_logger or logger).getChild("DummyITS.EDP_v321_Fallback") # Changed version
        self.config_path_used = config_path
        # self.ids_imported_successfully = ids_imported_successfully # Store the flag - REMOVED
        self.logger.warning(f"Initializing DummyIntegratedTradingSystem_EDP (EDP Fallback). Config path: '{config_path}'") # Removed IDS status
    ...
    def process_market_data_and_generate_recommendations(self, **kwargs) -> Dict[str, Any]:
        ...
        # Assuming IDS_IMPORTED_SUCCESSFULLY_EDP is available globally or True for this dummy context
        ...
        ] if IDS_IMPORTED_SUCCESSFULLY_EDP else [ # Fallback if global flag is somehow False here
...
[end of data_management/enhanced_data_processor_v2.py]
